...
function makeRecordingInfo(overrides: Partial<{
    recordingId: string;
    sourceId: string;
    url: string;
    title: string;
    ...
    return {
        ...
        recordingDir: '/Users/jane.doe/Library/Application Support/OpenHeaders/recordings/rec-a1b2c3d4-e5f6-7890-abcd-ef1234567890',
        status: 'recording',
        ...overrides,
    };
}
