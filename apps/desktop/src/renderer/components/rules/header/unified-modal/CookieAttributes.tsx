...
const CookieAttributes: React.FC<CookieAttributesProps> = ({
  ...
  const handleExpirationPreset = (preset: ExpirationPreset) => {
    ...
    const seconds = preset.unit === 'hours' ? preset.value * 3600 : preset.value * 86400;
      ...
      {headerType === 'request' ? (
        ...
        <>
          ...
          <div style={{ display: 'flex', gap: '16px', marginBottom: 16 }}>
            ...
            >
              <Input placeholder="/ (default)" size="small" />
            </Form.Item>
          ...
          <div style={{ display: 'flex', gap: '16px', marginBottom: 16 }}>
            ...
            <div style={{ width: '280px' }}>
              <Form.Item label="SameSite" name="sameSite" initialValue="Lax" style={{ marginBottom: 8 }}>
                <Select
                  value={sameSite}
                  onChange={(value) => {
                    setSameSite(value);
            ...
            <div style={{ flex: 1 }}>
                ...
                <>
                  ...
                  <Space wrap>
                    {EXPIRATION_PRESETS.map((preset) => (
                      <Button key={preset.label} size="small" onClick={() => handleExpirationPreset(preset)}>
                        {preset.label}
                      </Button>
                    ))}
                  </Space>
              ...
              {expirationMode === 'expires' && (
                <Form.Item name="expires" style={{ marginBottom: 0 }}>
                  <DatePicker
                    showTime
                    style={{ width: '100%' }}
