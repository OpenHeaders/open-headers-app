...
const SettingsModal = ({ open, settings, onCancel, onSave, initialTab, initialAction }: SettingsModalProps) => {
  ...
  const handleSubmitWithValues = (valuesToSave?: SettingsValues) => {
    try {
      ...
      const finalValues = { ...(valuesToSave || formValues) };
      ...
      if (Object.hasOwn(finalValues, 'pendingVideoRecording')) {
  ...
  return (
    ...
    >
      ...
      >
        <PermissionAlert permissionAlert={permissionAlert} onClose={() => setPermissionAlert(null)} />
