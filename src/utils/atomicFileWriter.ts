...
class AtomicFileWriter {
   ...
   */
  async performAtomicWrite(filePath: string, content: string | Buffer): Promise<void> {
   ...
   */
  async acquireLock(lockPath: string, maxWaitTime: number = 5000): Promise<void> {
