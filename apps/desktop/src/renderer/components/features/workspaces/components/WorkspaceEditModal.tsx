...
const WorkspaceEditModal = ({ visible, workspace, onCancel, onSuccess }: WorkspaceEditModalProps) => {
  ...
  const renderFooter = () => {
    ...
    return (
      <Space style={{ width: '100%', justifyContent: 'flex-end' }}>
        ...
        <Button type="primary" loading={isUpdating} onClick={() => form.submit()} disabled={isUpdating}>
  ...
  return (
    <>
      ...
      >
        ...
        <Form form={form} layout="vertical" onFinish={handleFinish} style={{ paddingBottom: 20 }} disabled={isUpdating}>
            ...
            items={[
              {
                ...
                children: (
                  <>
                    ...
                    <Form.Item label="Workspace Type" style={{ marginBottom: 16 }}>
                      <Space>
