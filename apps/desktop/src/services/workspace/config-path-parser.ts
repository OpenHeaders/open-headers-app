...
interface ParsedPathCommaSeparated {
...
interface ParsedPathBasePath {
  type: 'base-path';
  basePath: string;
  baseFileName: string;
  primaryPath: string;
  multiFileConfig: string;
  multiFileEnv: string;
}

type ParsedPath = ParsedPathSingle | ParsedPathCommaSeparated | ParsedPathFolder | ParsedPathBasePath;
 ...
 */
function getSearchPatterns(parsedPath: ParsedPath): SearchPatterns {
