...
import { Alert, Button, Card, Form, Input, Progress, Space, Switch, Tag, Typography } from 'antd';
...
const TotpAuthCard: React.FC<TotpAuthCardProps> = ({
  ...
  return (
    <Card
      ...
      extra={
        <Form.Item name="enableTOTP" valuePropName="checked" noStyle>
          <Switch size="small" checkedChildren="On" unCheckedChildren="Off" onChange={handleTotpToggle} />
        </Form.Item>
      }
    ...
    >
      <Form.Item
        noStyle
        shouldUpdate={(prevValues, currentValues) => prevValues.enableTOTP !== currentValues.enableTOTP}
      >
        {({ getFieldValue }) => {
            ...
            <>
              ...
              <div style={{ marginTop: 4, marginBottom: 4 }}>
                <Text type="secondary" style={{ fontSize: 11 }}>
                  <strong>Tips:</strong> Enter the secret key and click Test button. TOTP Code is generated
                  automatically based on secret key.
                </Text>
              </div>
              ...
              <Space style={{ marginTop: 8 }}>
                ...
                <Text type="secondary" style={{ fontSize: 11 }}>
                  to use the value in URL, headers, query params, body
                </Text>
              </Space>
              {/* TOTP Cooldown Warning */}
              <Form.Item
                noStyle
                shouldUpdate={(prevValues, currentValues) => prevValues.totpSecret !== currentValues.totpSecret}
              >
                {({ getFieldValue }) => {
