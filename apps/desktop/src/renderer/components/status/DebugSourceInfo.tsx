          ...
          <div style={{ marginTop: 10 }}>
            {httpSources.map((source) => {
              ...
              return (
                <div
                  key={source.sourceId}
                  style={{ marginBottom: 10, borderBottom: '1px solid #444', paddingBottom: 5 }}
                >
                  ...
                  <div>
                    ...
                    {source.refreshOptions?.lastRefresh
                      ? new Date(source.refreshOptions.lastRefresh).toLocaleTimeString()
                      : 'Never'}
                  </div>
                  ...
                  {status.failureCount > 0 && <div style={{ color: '#ff6b6b' }}>Failures: {status.failureCount}</div>}
                </div>
              );
            })}
          </div>
