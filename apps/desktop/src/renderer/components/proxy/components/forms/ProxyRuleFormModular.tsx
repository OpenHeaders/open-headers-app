...
import { createHeaderNameValidator, createHeaderValueValidator, validateRuleName } from './ProxyRuleFormValidation';
...
const ProxyRuleForm = ({ visible, onCancel, onSave, rule, sources = [], headerRules = [] }: ProxyRuleFormProps) => {
  ...
  return (
    ...
    >
      <Form ref={formRef} form={form} layout="vertical" onFinish={handleSubmit} autoComplete="off" scrollToFirstError>
        {/* Rule Name */}
        <Form.Item name="name" label="Rule Name" rules={validateRuleName}>
          <Input placeholder="e.g., Add Authentication Header" size="small" />
        </Form.Item>
        ...
        <div style={{ marginBottom: 16 }}>
          ...
          <HeaderTypeSelector headerType={headerType} setHeaderType={setHeaderType} form={form} />
