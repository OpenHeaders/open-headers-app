  ...
  return (
    <div>
      ...
      <Text type="secondary" style={{ fontSize: 13 }}>
        Choose how you want to export this recording
      </Text>
        ...
        <Space direction="vertical" size={12} style={{ width: '100%' }}>
          ...
          <Radio
            ...
            style={{
              ...
              // Theme-aware borders
              border:
                exportType === 'json' ? `1px solid ${token.colorSuccessBorder}` : `1px solid ${token.colorBorder}`,
              transition: 'all 0.2s',
            }}
          >
            <Space align="start">
              ...
              <div>
                ...
                <Text type="secondary" style={{ fontSize: 12, lineHeight: 1.5 }}>
                  Complete recording with DOM events, console logs, network activity, storage changes, and other
                  metadata. Can be imported back for playback.
                </Text>
              </div>
            </Space>
          </Radio>
