...
const TeamWorkspaceShareInviteModal = ({ visible, workspace, onClose }: TeamWorkspaceShareInviteModalProps) => {
  ...
  return (
    <Modal
      title={
        <Space>
          Invite to team workspace <TeamOutlined />
          {workspace.name}
        </Space>
      }
      open={visible}
      ...
      <Space direction="vertical" style={{ width: '100%' }} size={20}>
            ...
            options={[
              {
                label: (
                  <div style={{ padding: '4px 0' }}>
                    ...
                    <div style={{ fontSize: 11, opacity: 0.65, fontWeight: 'normal' }}>No app installed yet</div>
                  </div>
                ),
                value: 'web',
              },
              {
                label: (
                  <div style={{ padding: '4px 0' }}>
                    ...
                    <div style={{ fontSize: 11, opacity: 0.65, fontWeight: 'normal' }}>Have app installed</div>
                  </div>
                ),
                value: 'app',
              },
        ...
        >
          ...
          >
            ...
            <li>
              (Optional) Environment values must be imported separately via &apos;Menu &rarr; Import&apos; or
              &apos;Share Environment&apos;
            </li>
          </ul>
        </div>
