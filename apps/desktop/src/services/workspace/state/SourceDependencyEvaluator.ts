 ...
 */
export function evaluateSourceDependencies(source: Source, envResolver: EnvironmentResolverLike | null): DependencyResult {
 ...
 */
export function evaluateAllSourceDependencies(sources: Source[], envResolver: EnvironmentResolverLike | null): Source[] {
 ...
 */
export function activateReadySources(sources: Source[], envResolver: EnvironmentResolverLike | null): { sources: Source[]; activated: number; hasChanges: boolean } {
    let activated = 0;
