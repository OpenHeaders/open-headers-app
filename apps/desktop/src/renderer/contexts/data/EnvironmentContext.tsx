...
import { useCentralizedEnvironments } from '@/renderer/hooks/useCentralizedEnvironments';
...
export { useCentralizedEnvironments as useEnvironments } from '@/renderer/hooks/useCentralizedEnvironments';
