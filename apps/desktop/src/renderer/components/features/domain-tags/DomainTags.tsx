...
const DomainTags = ({
  ...
  onValidate?: (tags: string[]) => void;
  validationResults?: DomainValidation[];
}) => {
  // Input state management
  const [inputVisible, setInputVisible] = useState(false);
  const [inputValue, setInputValue] = useState('');
  const [currentInputValidation, setCurrentInputValidation] = useState<
  ...
  return (
    <div className="domain-tags-container">
      ...
      <DomainActionsHeader domains={value} onChange={onChange ?? (() => {})} helpComponent={<DomainInputHelp />} />
