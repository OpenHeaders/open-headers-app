    ...
    <>
      ...
      {isExpanded && (
        ...
        >
          ...
          {networkState?.error ? (
            <div style={{ color: '#ff6b6b' }}>Error: {networkState.error}</div>
          ) : networkState ? (
            <div style={{ display: 'grid', gridTemplateColumns: '140px 140px 140px 140px', gap: '10px' }}>
              ...
              <div>
                ...
                <div>
                  State:{' '}
                  <span style={{ color: networkState.isOnline ? '#51cf66' : '#ff6b6b' }}>
              ...
              <div>
                ...
                <div style={{ fontSize: 10 }}>
                  <div>
                    State: {networkState.lastUpdate ? new Date(networkState.lastUpdate).toLocaleTimeString() : 'N/A'}
                  </div>
