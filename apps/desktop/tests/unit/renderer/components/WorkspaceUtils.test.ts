...
import { PROVIDER_ICONS } from '@/renderer/components/features/workspaces/constants/WorkspaceConstants';
...
} from '@/renderer/components/features/workspaces/utils/WorkspaceUtils';
