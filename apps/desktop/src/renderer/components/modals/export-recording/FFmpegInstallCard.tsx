      ...
      description={
        <Space orientation="vertical" size={8} style={{ width: '100%' }}>
          ...
          {installStatus ? (
                ...
                <>
                  <Text type="secondary">
                    ...
                    {downloadSize.total > 0 && (
                      <span>
                        ({Math.round(downloadSize.downloaded / 1024 / 1024)}MB /{' '}
                        {Math.round(downloadSize.total / 1024 / 1024)}MB)
                      </span>
                    )}
                  </Text>
            ...
            /* Install Button */
            <Button type="primary" size="small" onClick={handleInstallFFmpeg} icon={<DownloadOutlined />}>
              Install FFmpeg
            </Button>
          )}
        </Space>
