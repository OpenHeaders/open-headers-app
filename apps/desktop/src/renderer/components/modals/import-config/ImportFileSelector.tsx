import { FileOutlined, FolderOutlined, QuestionCircleOutlined, UploadOutlined } from '@ant-design/icons';
import { Alert, Button, Space, Tabs, Tooltip, Typography, Upload } from 'antd';
      ...
      items={[
        {
          ...
          children: (
            <div>
              ...
              <div
                style={{ textAlign: 'center', padding: '40px 20px', border: '1px dashed #d9d9d9', borderRadius: '6px' }}
              >
                <Upload
                  accept=".json"
                  ...
                  disabled={analyzing}
                >
                  <Button type="primary" icon={<UploadOutlined />} size="large" disabled={analyzing}>
                    Browse Files
                  </Button>
                </Upload>
