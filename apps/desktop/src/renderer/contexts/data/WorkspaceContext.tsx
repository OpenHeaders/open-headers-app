...
import { useWorkspaces as useCentralizedWorkspaces } from '@/renderer/hooks/useCentralizedWorkspace';
...
export { useWorkspaces } from '@/renderer/hooks/useCentralizedWorkspace';
