            ...
            description={
              <Space orientation="vertical">
                ...
                <ul style={{ margin: '8px 0', paddingLeft: '20px' }}>
                  <li>
                    <Text>
                      <strong>Why it's needed:</strong> Browser workflow recordings capture DOM mutations and user
                      interactions, but external resources (images, fonts, stylesheets) need to be loaded separately
                      during replay.
                    </Text>
                  </li>
                  <li>
                    <Text>
                      <strong>What's recorded:</strong> Only DOM changes, user events, and metadata are recorded.
                      External resources URLs are captured but not their content.
                    </Text>
                  </li>
                  <li>
                    <Text>
                      <strong>What's not recorded:</strong> Actual file contents (images, CSS, JS files).
                    </Text>
                  </li>
                </ul>
                ...
                <ul style={{ margin: '8px 0', paddingLeft: '20px' }}>
                  <li>
                    <Text>The recording player reconstructs the DOM and replays user interactions in sequence.</Text>
                  </li>
                  <li>
                    <Text>
                      External resources are fetched through the proxy server, which can inject authentication headers
                      for protected environments.
                    </Text>
                  </li>
                  <li>
                    <Text>The proxy cache stores frequently used resources locally for faster subsequent replays.</Text>
                  </li>
                </ul>
                <Divider style={{ margin: '12px 0' }} />
                <Text type={'secondary' as never}>
                  <strong>💾 Storage efficiency:</strong> Recordings are typically 10-100x smaller than video files
                  (.mp4) while providing perfect fidelity DOM reconstruction.
                </Text>
                <br />
                <Text>
                  <strong>
                    <InfoCircleOutlined /> Protected environments:
                  </strong>{' '}
                  For authenticated resources, configure proxy rules to inject the necessary headers (e.g.,
                  Authorization, Cookie) to fetch missing assets during replay.
                </Text>
              </Space>
            }
            type="info"
