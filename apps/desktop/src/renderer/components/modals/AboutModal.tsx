            ...
            <div className="tab-content">
              ...
              <Space direction="vertical" style={{ width: '100%' }}>
                ...
                <Button
                  ...
                  onClick={() =>
                    openExternal('https://chromewebstore.google.com/detail/ablaikadpbfblkmhpmbbnbbfjoibeejb')
                  }
                  style={{
                    width: '100%',
                    textAlign: 'left',
                ...
                <Button
                  ...
                  onClick={() =>
                    openExternal(
                      'https://microsoftedge.microsoft.com/addons/detail/open-headers/gnbibobkkddlflknjkgcmokdlpddegpo',
                    )
                  }
                  style={{
                    width: '100%',
