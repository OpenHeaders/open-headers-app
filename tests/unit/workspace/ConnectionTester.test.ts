...
describe('ConnectionTester', () => {
    ...
    describe('suggestAlternativeBranches()', () => {
        const branches = ['main', 'master', 'develop', 'workspace/staging-env', 'workspace/production', 'feature/oauth2-headers'];
    ...
    describe('classifyError()', () => {
        it('classifies auth errors', () => {
            ...
            expect(tester.classifyError(new Error('authentication failed for https://github.com/OpenHeaders/open-headers-app.git'))).toBe('AUTH_ERROR');
