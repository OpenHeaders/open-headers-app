...
// Globals - must be declared before singleton check for module.exports
let mainWindow = null;
...
// Implement singleton instance lock
...
if (!gotTheLock) {
    ...
    // This is the primary instance - continue with normal startup
...
// Create the tray icon and associated context menu
    ...
    app.on('second-instance', (event, commandLine, workingDirectory) => {
        ...
        // When another instance is started, focus our window instead
        // Use BrowserWindow.getAllWindows() to avoid referencing mainWindow before it's created
