...
describe('WebSocketService', () => {
    ...
    describe('isConnected', () => {
        ...
        it('returns true when a single client is connected', () => {
            service.connectedClients.set('WS-1709123456789-a1b2c3d4e', makeClientInfo({
    ...
    describe('_broadcastToAll', () => {
        it('returns 0 when no servers', () => {
            const count = service._broadcastToAll(JSON.stringify({
                type: 'rules-update',
    ...
    describe('_dispatchMessage', () => {
        ...
        it('dispatches saveRecording to recordingHandler', () => {
            ...
            service._dispatchMessage(mockWs, { type: 'saveRecording', recording } as Parameters<typeof service._dispatchMessage>[1]);
        ...
        it('dispatches saveWorkflow to recordingHandler', () => {
            ...
            service._dispatchMessage(mockWs, { type: 'saveWorkflow', recording } as Parameters<typeof service._dispatchMessage>[1]);
