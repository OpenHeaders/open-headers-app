      ...
      <Space direction="vertical" style={{ width: '100%' }}>
        ...
        {includeWorkspace && (
          <div style={{ marginLeft: 24 }}>
            <Checkbox checked={includeCredentials} onChange={(e) => onIncludeCredentialsChange(e.target.checked)}>
              <Space>
        ...
        <Text type="secondary" style={{ fontSize: '12px' }}>
          <InfoCircleOutlined /> When workspace configuration is included, team members can import the file and
          immediately start syncing from the same Git repository without manual setup.
        </Text>
      </Space>
    </Card>
  );
