...
import { Card, Space, Typography, Tag, InputNumber, Alert } from 'antd';
...
interface ConnectionsServerStatusProps { status: ConnectionsServerStatusData; tutorialMode: boolean; }
            ...
            <Space direction="vertical" style={{ width: '100%' }}>
                ...
                {tutorialMode && (
                    <Alert
                        ...
                        description={
                            <div>
                                <div>The WebSocket server enables real-time communication between this app and your browser extensions.</div>
                                <div style={{ marginTop: 8 }}>
                                    <Text code>Port {status.wsPort}</Text> — Used by Chrome, Edge, Firefox, and Safari
                                </div>
                                <div style={{ marginTop: 8 }}>
                                    Listens on localhost only — connections are never exposed to your network, only local browser extensions can connect.
                                </div>
                            </div>
                        }
                        type="info"
