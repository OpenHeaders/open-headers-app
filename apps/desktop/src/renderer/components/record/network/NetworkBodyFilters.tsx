...
interface NetworkBodyFiltersProps {
  bodyFilters: BodyFilters;
  onBodyFiltersChange: (filters: BodyFilters | ((prev: BodyFilters) => BodyFilters)) => void;
  token: GlobalToken;
}
const NetworkBodyFilters = ({ bodyFilters, onBodyFiltersChange, token }: NetworkBodyFiltersProps) => {
  ...
  return (
    <Dropdown menu={bodyFilterMenu} trigger={['click']} placement="bottomLeft">
